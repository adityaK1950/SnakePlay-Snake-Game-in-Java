...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void play() {
        ...
        timer = new Timer(120, this); // Adjusted delay value
        timer.start();
    }
    ...
    public void gameOver(Graphics graphics) {
		...
		graphics.drawString("Score: " + foodEaten, (WIDTH - metrics.stringWidth("Score: " + foodEaten)) / 2,
				HEIGHT / 2 + 50); // Move the score text down by 50 pixels
	
		// Draw restart button
		restartButton.setBounds((WIDTH - 100) / 2, HEIGHT / 2 + 100, 100, 40);
    ...
    public class RestartListener implements ActionListener {
		...
		public void setupTimer() {
			timer = new Timer(500, new ActionListener() { // Adjusted delay value
				@Override
				public void actionPerformed(ActionEvent e) {
					if (running) {
						move();
